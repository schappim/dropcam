...
exports.fetchIpModal = {
  "contents":[
    ...
    { "type":"input_field_text", "field_name": "username", "value": "", "label": "Snapshot Url", "placeholder": "username", "required": true},
    { "type":"input_field_text", "field_name": "password", "value": "", "label": "Snapshot Url", "placeholder": "password", "required": true},
